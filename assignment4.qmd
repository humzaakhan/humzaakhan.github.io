...
1. Rerun programs in Gentle Introduction to Machine Learning notebook 
(https://datageneration.org/gentlemachinelearning/module4_unsupervisedlearning)
...
plot(as.phylo(fit), type = "unrooted", cex = 0.6,
     no.margin = TRUE)

plot(as.phylo(fit), type = "fan")


plot(as.phylo(fit), type = "cladogram", cex = 0.6,
