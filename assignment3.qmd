...
Q: Run a regplot on the dependent variable using:
a. Age
b. Education
c. Income
...
The DV has a lot of values. We can see this by using the unique function below. A different approach, such as using a multinomial logit regression would be better suited. Methods such as linear regression are weak for this case.
